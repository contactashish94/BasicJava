...
public class Number_Factors_DP_TopDown {
	...
	public static void main(String[] args) {
		Number_Factors_DP_TopDown en = new Number_Factors_DP_TopDown();
		...
		System.out.println();
		System.out.println("Total time to execute by Dynamic Programming by Number_Factors_DP_TopDown: =" + (end-start));
	}//End of method
