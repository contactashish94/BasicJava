package com.ashish.durgasoft.threading.threadcomm.notifyALl;
...
public class ObjectDemo extends Object {
    ...
    public String removeElement() throws InterruptedException {
        synchronized (synchedList) {
            ...
            while (synchedList.isEmpty()) {
                System.out.println("List is empty..., waiting for notification" + System.currentTimeMillis());
                synchedList.wait();
    ...
    public void addElement(String element) {
        ...
        synchronized (synchedList) {
            ...
            System.out.println("New Element: in addElement method ... '" + element + "' added");
            System.out.println("Thread sleeping 5 seconds");
            try {
                Thread.sleep(5000);
